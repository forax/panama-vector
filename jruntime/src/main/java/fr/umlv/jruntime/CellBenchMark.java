...
// /path/to/jdk-15-vector/bin/java --enable-preview --module-path target/test/artifact:deps  -Dfr.umlv.jruntime.vectorized=true  -m fr.umlv.vector/fr.umlv.jruntime.CellBenchMark
...
public class CellBenchMark {
  ...
  private final int[] array = new Random(0).ints(1_000_000, 0,100).toArray();
  private final Cell cell = Cell.of(array);
